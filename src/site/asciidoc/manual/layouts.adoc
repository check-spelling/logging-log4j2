...
|mapMessageIncludes
|String
|A comma separated list of attributes from the MapMessage to include when formatting the event. This
...
**Note:** JsonTemplate is considered deprecated. JsonTemplateLayout provides more capabilities and
...
Configuration in the "substitutor" variables, and the log event in the
